...
SELECT
  ...
  (SELECT selas.name FROM 
    ...
    WHERE group_info_teachers.academy_id = academy.academy_id 
		AND employee.employee_id = group_info_teachers.employee_id
        AND group_info_teachers.teacher_type_id IN (1, 2)
