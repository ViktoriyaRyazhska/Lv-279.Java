    ...
    static {
        ...
        predicates.put(
                ...
                student -> {
                    EnglishLevel englishLevel =
                            student.getData().getEnglishLevel();
                    return englishLevel != null &&
                            englishLevel.getEnglishLevelId() >= EL_PRE_INTERMEDIATE_ID;
                }
        );
        predicates.put(
                "entryScoreDefined",
                student -> student.getData().getEntryScore() != null
        );
        predicates.put(
                "incomingTestDefined",
                student -> student.getData().getIncomingTest() != null
        );
        predicates.put(
                "approvedByDefined",
                student -> student
        ...
        predicates.put(
                ...
                student -> student.getTeacherFeedback() != null &&
                        student.getData().getTeacherScore() != null
        );
        predicates.put(
                "expertFeedbacksFilledIn",
                student -> student.getExpertFeedback() != null &&
                        student.getData().getExpertScore() != null
        );
        predicates.put(
                "finalTestBasePass",
