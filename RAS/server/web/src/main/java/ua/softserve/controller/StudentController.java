...
// public String addStudents(@PathVariable("academyId") Integer academyId, @RequestBody(required = false)
...
// public String deleteStudents(@PathVariable("academyId") Integer academyId, @RequestBody(required = false)
// MultiValueMap<String, String> formData) {
// if (formData != null) {
// List<Integer> userIds = parseData(formData);
// if (userIds.size() > 0) {
