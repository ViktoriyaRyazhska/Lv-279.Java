...
var appRoutes = [
    { path: 'main/viewAcademies', component: __WEBPACK_IMPORTED_MODULE_2__components_view_academies_view_academies_component__["a" /* ViewAcademiesComponent */] },
    { path: 'main/addgroup', component: __WEBPACK_IMPORTED_MODULE_3__components_group_add_group_add_group_component__["a" /* AddGroupComponent */] },
    { path: 'main/history', component: __WEBPACK_IMPORTED_MODULE_4__components_history_history_list_history_list_component__["a" /* HistoryListComponent */] },
    { path: 'main/students', component: __WEBPACK_IMPORTED_MODULE_5__components_students_students_component__["a" /* StudentsComponent */] },
    { path: 'main/marks', component: __WEBPACK_IMPORTED_MODULE_6__components_feedbacks_feedback_detail_feedback_teacher_detail_feedback_teacher_detail_component__["a" /* FeedbackTeacherDetailComponent */] }
];
...
module.exports = "<h1>HELLO</h1>\n<nav>\n  <a routerLink=\"main/history\">History2</a>\n</nav>\n<router-outlet></router-outlet>\n"
