...
var appRoutes = [
    { path: 'viewAcademies', component: __WEBPACK_IMPORTED_MODULE_2__components_view_academies_view_academies_component__["a" /* ViewAcademiesComponent */] },
    { path: 'addgroup', component: __WEBPACK_IMPORTED_MODULE_3__components_group_add_group_add_group_component__["a" /* AddGroupComponent */] },
    ...
    { path: 'marks', component: __WEBPACK_IMPORTED_MODULE_6__components_feedbacks_feedback_detail_feedback_teacher_detail_feedback_teacher_detail_component__["a" /* FeedbackTeacherDetailComponent */] }
];
...
module.exports = "<h1>HELLO</h1>\n<nav>\n  <a routerLink=\"/history\">History2</a>\n</nav>\n<!--<router-outlet></router-outlet>-->\n"
...
module.exports = "<div class=\"col-lg-12 well\">\n  <form>\n    <h4>Add Feedback</h4>\n    <div class=\"row\">\n      <div class=\"col-sm-12\">\n        <div class=\"row\">\n          <div class=\"col-sm-2 form-group\">\n            Learning ability\n          </div>\n          <div class=\"col-sm-3 form-group\">\n            <select class=\"form-control input-sm\" [(ngModel)] =\"desc\" name=\"descName\">\n              <ng-container *ngFor=\"let mark of marks\">\n                <option *ngIf=\"mark.characteristic.id == one\">{{mark.mark}}</option>\n              </ng-container>\n            </select>\n          </div>\n          <div class=\"col-sm-7 form-group\">\n            <!--{{mark.description}}-->\n          </div>\n        </div>\n        <button type=\"submit\" class=\"btn btn-primary\" (click)=\"onSave()\">asdf</button>\n\n        <!--<div class=\"row\">-->\n          <!--<div class=\"col-sm-2 form-group\">-->\n            <!--<lable>Overall technical competence</lable>-->\n          <!--</div>-->\n          <!--<div class=\"col-sm-3 form-group\">-->\n            <!--<select class=\"form-control input-sm\">-->\n              <!--<option *ngFor=\"let academy of academyStages\" [value]=\"academy.stageId\">{{academy.name}}</option>-->\n            <!--</select>-->\n          <!--</div>-->\n          <!--<div class=\"col-sm-7 form-group\">-->\n            <!--<lable id=\"otDesc\">Technically skilful, good technical background on different levels</lable>-->\n          <!--</div>-->\n        <!--</div>-->\n\n        <!--<div class=\"row\">-->\n          <!--<div class=\"col-sm-2 form-group\">-->\n            <!--<lable>Passional initiative</lable>-->\n          <!--</div>-->\n          <!--<div class=\"col-sm-3 form-group\">-->\n            <!--<select class=\"form-control input-sm\">-->\n              <!--<option *ngFor=\"let academy of academyStages\" [value]=\"academy.stageId\">{{academy.name}}</option>-->\n            <!--</select>-->\n          <!--</div>-->\n          <!--<div class=\"col-sm-7 form-group\">-->\n            <!--<lable id=\"piDesc\">Highly motivated to grow in chosen direction, shows initiative to get all needed-->\n              <!--knowledge and information for effective growth-->\n            <!--</lable>-->\n          <!--</div>-->\n        <!--</div>-->\n\n        <!--<div class=\"row\">-->\n          <!--<div class=\"col-sm-2 form-group\">-->\n            <!--<lable>Team work</lable>-->\n          <!--</div>-->\n          <!--<div class=\"col-sm-3 form-group\">-->\n            <!--<select class=\"form-control input-sm\">-->\n              <!--<option *ngFor=\"let academy of academyStages\" [value]=\"academy.stageId\">{{academy.name}}</option>-->\n            <!--</select>-->\n          <!--</div>-->\n          <!--<div class=\"col-sm-7 form-group\">-->\n            <!--<lable id=\"twDesc\">Work as team member, cooperates with others to achieve team goals</lable>-->\n          <!--</div>-->\n        <!--</div>-->\n\n        <!--<div class=\"row\">-->\n          <!--<div class=\"col-sm-2 form-group\">-->\n            <!--<lable>Getting things done</lable>-->\n          <!--</div>-->\n          <!--<div class=\"col-sm-3 form-group\">-->\n            <!--<select class=\"form-control input-sm\">-->\n              <!--<option *ngFor=\"let academy of academyStages\" [value]=\"academy.stageId\">{{academy.name}}</option>-->\n            <!--</select>-->\n          <!--</div>-->\n          <!--<div class=\"col-sm-7 form-group\">-->\n            <!--<lable id=\"gtDesc\">Finish tasks in time even if this will take extra efforts</lable>-->\n          <!--</div>-->\n        <!--</div>-->\n\n        <!--<div class=\"row\">-->\n          <!--<div class=\"col-sm-2 form-group\">-->\n            <!--<lable>Active Communicator</lable>-->\n          <!--</div>-->\n          <!--<div class=\"col-sm-3 form-group\">-->\n            <!--<select class=\"form-control input-sm\">-->\n              <!--<option *ngFor=\"let academy of academyStages\" [value]=\"academy.stageId\">{{academy.name}}</option>-->\n            <!--</select>-->\n          <!--</div>-->\n          <!--<div class=\"col-sm-7 form-group\">-->\n            <!--<lable id=\"acDesc\">Good communication skills. Doesn't be afraid to talk to other students, teachers,-->\n              <!--experts. Clearly describes his/her point of view. Listening skills are good as well.-->\n            <!--</lable>-->\n          <!--</div>-->\n        <!--</div>-->\n\n        <!--<div class=\"row\">-->\n          <!--<div class=\"col-sm-2 form-group\">-->\n            <!--<lable>Summary</lable>-->\n          <!--</div>-->\n          <!--<div class=\"col-sm-10 form-group\">-->\n            <!--<input type=\"text\" placeholder=\"Summary\"-->\n                   <!--class=\"form-control input-sm\"/>-->\n          <!--</div>-->\n        <!--</div>-->\n      </div>\n    </div>\n  </form>\n</div>\n<div align=\"button\">\n  <button type=\"submit\" class=\"btn btn-primary\" (click)=\"onSaveFeedback()\">Save Feedback</button>\n</div>\n"
...
var FeedbackTeacherDetailComponent = (function () {
    ...
    FeedbackTeacherDetailComponent.prototype.onSave = function () {
...
var ViewAcademiesComponent = (function () {
    ...
    ViewAcademiesComponent.prototype.ngOnInit = function () {
        ...
        this.academyService.getAll().subscribe(function (data) {
            ...
            _this.filteredAcademies = data;
            _this.academyStages = data[0].academyStages;
            _this.cityNames = data[0].cityNames;
            _this.direction = data[0].direction;
            _this.profile = data[0].profile;
            _this.technology = data[0].technologie;
            _this.setPage(1);
        }, function (error) { return console.log(error); });
    };
