...
public class RandomUtil {
     ...
     * <b>This value is inaccurate because of different number of days in the month</b>
     */
    ...
    private final static String[] GROUP_NAMES_SUFIX = {
            "Java", "DotNet", "QC", "ISTQB", "Angulyar",
            "FrontEnd", "Dev", "JS", "NodeJS", "Ruby"
    };
    private final static String[] GROUP_STATUSES = {
            "In Process", "Offering", "Graduated"
    };
    private final static String[] STUDENT_STATUSES = {
            "Trainee", "Accepted pre-offer",
            "Graduated", "Rejected"
    };
    private final static int START_INDEX_CORRECT_ENGLISH_LEVEL = 7;
    private final static String[] ENGLISH_LEVELS = {
            "Beginner low", "Beginner", "Beginner high",
            "Elementary low", "Elementary", "Elementary high",
            "Pre-Intermediate low", "Pre-Intermediate", "Pre-Intermediate high",
            "Intermediate low", "Intermediate", "Intermediate high",
            "Upper intermediate low", "Upper intermediate", "Upper intermediate high",
            "Advanced low", "Advanced", "Advanced high",
            "Proficient low", "Proficient", "Proficient high"
    };
    private final static String[][] FEEDBACKS = {
            {"QUICK", "NORMAL", "HARD TO LEARN", "CAN'T EVALUATE"},
    ...
    public final static String[] MAN_SECOND_NAMES = {
            ...
            "Ostapovych", "Tymofiyovych", "Petrovych",
            "Pavlovych", "Bohdanovych", "Tarasovych",
    ...
    public final static String[] WOMAN_SECOND_NAMES = {
            ...
            "Ostapivna", "Tymofiyivna", "Petrivna",
            "Pavlivna", "Bohdanivna", "Tarasivna",
    ...
    private final static String[] EMAIL_DOMAINS = {
            ...
            "@softserve.ua", "@softserveinc.com",
            "@ukr.net", "@gov.ua"
    };
    private final static String[] CITIES = {
            "Lviv", "Kyiv", "Frankivsk", "Chernivci",
            "Rivne", "Kharkiv", "Vinnytsya", "Odesa"
    };
    ...
    public static String getRandomCorrectEnglishLevel() {
        return ENGLISH_LEVELS[
                random.nextInt(ENGLISH_LEVELS.length - START_INDEX_CORRECT_ENGLISH_LEVEL)
