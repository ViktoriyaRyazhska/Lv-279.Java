...
<div class="container">
    <div class="col-lg-12 well">
        ...
        <div class="row">
            ...
            <c:forEach items="${indxList}" var="indxL">
                <input type="hidden" id="mapInp${indxL}" value="${mapAP[indxL]}"/>
            </c:forEach>
        </div>
...
<script>
    $('.laSelect').change(function (e) {
        ...
        console.log(val);
        if(val < 5) {
            $('#laDesc').text($("#mapInp"+val).val());
        } else if(val < 9) {
            $('#otDesc').text($("#mapInp"+val).val());
        } else if(val < 12) {
            $('#piDesc').text($("#mapInp"+val).val());
        } else if(val < 16) {
            $('#twDesc').text($("#mapInp"+val).val());
        } else if(val < 19) {
            $('#gtDesc').text($("#mapInp"+val).val());
        } else {
            $('#acDesc').text($("#mapInp"+val).val());
        }
    });
</script>
</body>
